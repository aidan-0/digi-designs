...
const Navbar = () => {
	return (
		...
		<Element
			name="top"
			className=" shadow rounded-b-xl top-0 sticky z-50 w-full bg-dd bg-card dark:bg-background-darker flex items-center justify-between py-6 px-4 md:px-8"
		>
			<Link href="/">
				<Image
		...
		{/* "border border-input bg-card  dark:bg-background dark:hover:bg-card hover:text-accent-foreground p-[22px]", */}
