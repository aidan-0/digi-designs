...
export function BackgroundBeamsDemo() {
  return (
    ...
    <>
      <div className="mt-20 py-10 md:py-20 rounded-[40px] bg-dd-dark dark:bg-background-darkest  flex flex-col items-center justify-center relative w-full px-6 md:px-0">
